...
class Database {
    ...
    /**
     * Diagnostic function 
     * tells you more about why the SQL failed returns a div that contains a pretty formatted explainaton of why the SQL failed
     * @return string a div object containing a table 
     */
    function explain() {
        $temp = $this->_sql;
        ...
        return "<div id='framework_explain' style=\"background-color:#FFFFCC\" align=\"left\">$buf</div>";
    }
